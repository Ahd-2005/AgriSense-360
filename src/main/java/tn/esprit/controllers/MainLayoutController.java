...
public class MainLayoutController {
    ...
    public void navigateToHome() {
        loadContent("/fxml/home-adapted.fxml");
        setActiveButton(homeBtn);
    }

    @FXML
    public void navigateToAnimals() {
        loadContent("/fxml/animals_management_view-adapted.fxml");
        setActiveButton(animalsBtn);
    }

    @FXML
    public void navigateToEquipment() {
        loadContent("/fxml/afficher_equipment-adapted.fxml");
    ...
    public void navigateToCulture() {
        loadContent("/fxml/afficher_culture-adapted.fxml");
        setActiveButton(cultureBtn);
    }

    @FXML
    public void navigateToUsers() {
        loadContent("/fxml/afficher_users-adapted.fxml");
        setActiveButton(usersBtn);
    }

    @FXML
    public void navigateToWorkers() {
        loadContent("/fxml/afficher_workers-adapted.fxml");
        setActiveButton(workersBtn);
    }

    // Méthodes pour les formulaires Stock
    @FXML
    ...
    // Méthodes pour les autres vues (ajoutez si nécessaire)
    @FXML
    public void navigateToParcelle() {
        loadContent("/fxml/afficher_parcelle-adapted.fxml");
        setActiveButton(cultureBtn);
    }
    ...
    private void loadContent(String fxmlPath) {
        try {
            System.out.println("Loading content from: " + fxmlPath);
    ...
    private void showPlaceholder(String pageName) {
        ...
        Label message = new Label("This module will be implemented by your team members. Path: " + pageName);
        ...
        private void setActiveButton(Button activeButton) {
            ...
            // Ajoutez les autres boutons si définis
            if (ProdBtn != null) ProdBtn.getStyleClass().remove("active");
            if (addstockBtn != null) addstockBtn.getStyleClass().remove("active");
            if (adduserBtn != null) adduserBtn.getStyleClass().remove("active");
            if (addprodBtn != null) addprodBtn.getStyleClass().remove("active");
            if (liststockBtn != null) liststockBtn.getStyleClass().remove("active");
            if (ModstockBtn != null) ModstockBtn.getStyleClass().remove("active");
            if (editprodBtn != null) editprodBtn.getStyleClass().remove("active");
