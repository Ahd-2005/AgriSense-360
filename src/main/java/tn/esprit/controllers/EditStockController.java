...
public class EditStockController {
    ...
    public void initialize() {
        ...
        // Récupérer le stock à éditer
        Stock stock = MainLayoutController.getStockToEdit();
        if (stock != null) {
    ...
    public void setStockToEdit(Stock stock) {
        ...
        stockToEdit.setProduitId(Integer.parseInt(txtProduitId.getText().trim()));
    ...
    private void enregistrer() {
        // Contrôles de saisie simples
        if (txtProduitId.getText().trim().isEmpty()) {
            showAlert("Erreur", "Produit ID est obligatoire.");
            return;
        }
        try {
            Integer.parseInt(txtProduitId.getText().trim());
        } catch (NumberFormatException e) {
            showAlert("Erreur", "Produit ID doit être un nombre.");
            return;
        }
